function myFunction() {
  if (document.body.scrollTop > (($('#MyWork').offset().top)-150) || document.documentElement.scrollTop >  (($('#MyWork').offset().top))-150) {
    ...
    document.getElementById("myMenu").className = "navbar fixed-top navbar-expand-lg navbar-light border-bottom w-100 borde-ochre bg-pastel";
    ...
    document.getElementById("myMenu").className = "navbar fixed-top navbar-expand-lg navbar-dark border-bottom w-100 borde-golden bg-ivory";
    ...
    document.getElementById("rotate").className = "rotate1 mx-1 hashtag2 mt-2";
     ...
     document.getElementById("menu-size").className = "menu-size white-text mb-3";
      ...
      document.getElementById("myMenu").className = "navbar fixed-top navbar-expand-lg navbar-light border-bottom w-100 borde-redrush bg-white";
    document.getElementById("myLogo").className = "changeLogo logo1 socail-vertical mt-2";
